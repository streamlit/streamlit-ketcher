...
const KetcherEditorWrapper = styled.div<KetcherEditorWrapperProps>((props) => ({height: `${props.height}px`}))
...
interface StreamlitKetcherEditorProps extends Omit<Config, 'element' | 'staticResourcesUrl' | 'structServiceProvider'> {
  onInit?: (ketcher: Ketcher) => void;
  height: number
}

export const StreamlitKetcherEditor = ({height, ...rest}: StreamlitKetcherEditorProps) =>
